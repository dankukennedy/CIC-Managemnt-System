                    ...
                    <div class="col-lg-7">                     
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create an Account as CIC Manager</h1>
                                <h6 class="h4 text-gray-900 mb-4" > <?php  include('include/message.php'); ?></h6>
                            ...
                            <hr>
                           <!-- <div class="text-center">
                                <a class="medium" style="color:orange;" href="<?= base_url('forgetPassword.php')?>">Forgot Password?</a>
                            </div>-->
                            <div class="text-center">
                                <a class="medium" style="color:green,text-decoration:none;" href="<?php base_url('login.php') ?>">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
