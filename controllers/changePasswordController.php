...
// checking password strenght
  ...
  public function checkPassword($id,$password)
   ...
   $changePasswordQry="SELECT * FROM managers WHERE id='$manager_id' LIMIT 1";
   ...
   if($result->num_rows ==1)
    {
     ...
     public function changePassword($newPassword,$id)
     {
      ...
      $changePasswordQuery="UPDATE managers SET password='$newPassword' WHERE id='$manager_id' LIMIT 1";
