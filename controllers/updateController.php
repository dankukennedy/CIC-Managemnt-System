<?php class updateController
{
   ...
   public function edit($id)
   {
    ...
    $managerQuery="SELECT * FROM managers WHERE id='$manager_id' LIMIT 1";
 ...
 // $email= validateInput($this->conn,$_POST['email']);
  ...
  $subDivision=ucwords($subDivision );
    ...
    $managerUpdateQuery=" UPDATE managers SET fName='$fName',lastName='$lastName',otherName='$otherName',contact='$contact',field='$field',qualification='$qualification',working='$working',
