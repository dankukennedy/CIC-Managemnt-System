...
<div class="row">
  ...
  <div class="col-md-12">
 <h5 > <i style="color:seagreen; font:200"><?php  include('include/staff_message.php'); ?></i></h5>
    <div class="card">
     <div class="card-header" style="background-color: #3b5998 ;">
      <h5 style="color:white ;">Add CIC Pictures and Description</h5>
     </div>
       <div class="card-body">
       <form action="codes/staff_cicinfo_code.php" enctype="multipart/form-data" method="POST">
