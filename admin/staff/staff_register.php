                    ...
                    <div class="col-lg-7">                     
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <h6 class="h4 text-gray-900 mb-4" > <?php  include('include/staff_message.php'); ?></h6>
                            ...
                            <hr>
                            <!--<div class="text-center">
                                <a class="medium" style="color:orange;" href="<?= base_url('ad_forgetPassword.php')?>">Forgot Password?</a>
                            </div>-->
                            <div class="text-center">
                                <a class="medium" style="color:green;" href="<?php base_url('ad_login.php') ?>">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
