     ...
     <div class="card-header" style="background-color: #3b5998 ;">
      <h5 style="color:white ;">Add Records</h5>
       ...
       <form action="codes/staff_report_code.php" method="POST">
        ...
        <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
        <textarea class="form-control"  name="challenges" rows="10" cols="70" required placeholder="Write The Challenges Here"> Enter Challenges
        ...
        <div class="col-sm-6 mb-3 mb-sm-0">
        <textarea  class="form-control"  name="recommendation" rows="10" cols="70" required placeholder="Write The Recomendation Here"> Enter Recommendation
        ...
        <div class="mb-3">          
          <button type="submit" name="save_report" class="btn btn-outline-info">Save Report </button>
        </div>
