...
if(isset($_POST['deleteActivity'])) 
{
   ...
   if($result)
   {
      redirect("Activity Deleted Successfully","staff_viewActivity.php");
   }
   else
   {
      redirect("Something Went Wrong","staff_viewActivity.php");
    }
...
if($result)
{
   redirect("Activity Updated Successfully","staff_viewActivity.php");
}
  else
  {
