...
if(isset($_POST['deleteTraining'])) 
{
   ...
   if($result)
   {
      redirect("Training Deleted Successfully","staff_viewTraining.php");
   }
   else
   {
      redirect("Something Went Wrong","staff_viewTraining.php");
    }
...
if($result)
{
   redirect("Training Updated Successfully","staff_viewTraining.php");
}
  else
  {
   redirect("Something Went Wrong, Training Cannot Be Updated","staff_editTraining.php");
  }
...
$result=$training->createTraining($inputData);
 if($result)
 {
    redirect(" <h4 style='color:green; font:200'>Training Added Successfully</h4>","staff_train.php");
 } else
 {
    redirect("Something Went Wrong, Training Cannot Be Added","staff_addTraining.php");
 }
