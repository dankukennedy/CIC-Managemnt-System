...
<?php 
include_once('controllers/staff_RegisterController.php');
include_once('controllers/staff_loginController.php');
include_once('controllers/staff_updateController.php');
include_once('controllers/staff_changePasswordController.php');
...
if(isset($_POST['resetPassword']))
{
  ...
  { $result_passwordLenght=$managerChangePass->passwordLenght($newPassword);
     if( $result_passwordLenght)
     {
        ...
        if( $result_newPassSecurity)
          {  
            ...
            if($result_comparePass)
            {
              ...
              if( $password_hash)
                {
                     ...
                     {
                       {
                        ...
                        document.location.href='staff_settings.php';
                        </script>";
                        redirect(" <h5 style='color: green';> Password change successfully !!! </h5>","staff_settings.php");
                        ...
                        else
                        {
                          ...
                          document.location.href='staff_changePassword.php';
                          </script>";
                          redirect(" <h5 style='color: orange';> attempt to change New Password fails !!!  </h5>","staff_changePassword.php");
                 ...
                 else
                 {
                  ...
                  document.location.href='staff_changePassword.php';
                   ...
                   redirect(" <h5 style='color: orange';> New Password security fails !!!  </h5>","staff_changePassword.php");
                 }
            } 
            else{
              ...
              redirect(" <h5 style='color:  orange';> New Password and Repeat password does not Match up !!!  </h5>","staff_changePassword.php");
                }
            ...
            redirect(" <h5 style='color:  orange';> Enter password  mix with numbers,special characters,uppercases,lowercases !!  </h5>","staff_changePassword.php");
          }
      ...
      document.location.href='staff_changePassword.php';
          ...
          redirect(" <h5 style='color: orange';> Enter password up to 8 characters or more !!! </h5>","staff_changePassword.php");
   }
 ...
 redirect(" <h5 style='color: orange';> Password entered does not match with Current Password !!!  </h5>","staff_changePassword.php");
     }
...
if(isset($_POST['update']))
{
  ...
  if( $result)
  {
    ...
    redirect(" <h5 style='color: green';> Profile Updated  Successfully </h5>","staff_profile.php");
  }else 
  { 
    echo "  <script>
    alert(' Profile Update  fails   !!! ');
    document.location.href='staff_editProfile.php';
    </script>";
    redirect(" <h5 style='color: red';> Profile Update  fails </h5>","staff_editProfile.php");
...
if(isset($_POST['logout'])){
  ...
  if($checkLoggedOut){
    ...
    redirect(" <h5 style='color: green';> Loggedout Successfully !!! </h5>","staff_login.php");
  }
  ...
  $checkLogin=$auth->adminLogin($email,$password);
   ...
   { echo "  <script>
    ...
    document.location.href='index.php';
     ...
     {
      $checkAccount=$auth->adminAccount($email);
      if ($checkAccount){
        echo "  <script>
        alert('Please You dont Have an Account Create one ');
        document.location.href='staff_login.php';
        </script>";
             redirect("<h5 style='color: orange';>Please You dont Have an Account Create one !!!</h5>","staff_login.php");
         } 
        else{ 
          echo "  <script>
        ...
        document.location.href='ad_login.php';
           ...
           redirect("<h5 style='color: orange';> Invalid Email or Password !!!</h5>","staff_login.php");
...
if(isset($_POST['register']))
{
  ...
  if( $result_names){
      ...
      { 
        ...
        if(!$result_contact)
        {
           ...
           if(!$result_nia)
            {   $result_phoneNumber=$register->phoneNumberFormat($contact);
             if($result_phoneNumber)
             {
                ...
                if( $result_isCicnameEmpty)
                {
                  ...
                  if( $result_isGpsNameEmpty)
                  {
                        ...
                        if( $result_isRegionEmpty)
                          {
                            ...
                            { $result_isPasswordEmpty=$register->IsPasswordEmpty($password);
                              ...
                              if($result_isPasswordEmpty){
                                   ...
                                   if($register_query)
                                      {
                                        ...
                                        document.location.href='staff_login.php';
                                          ...
                                          redirect("<h4 style='color:green;'>Registered Successfully !!!</h4>","staff_login.php");
                                       }
                                     else
                                      {
                                        echo "  <script>
                                        alert(' Something Went Wrong !  ');
                                        document.location.href='staff_register.php';
                                        </script>";
                                         redirect("<h4 style='color: orange;'>Something Went Wrong !!!</h4>","staff_register.php");
                                      }
                                }  
                               else
                                {
                                ...
                                redirect("<h4 style='color: orange;' >Something Went Wrong with password seurity  !!!</h4>","staff_register.php");
                               }
                                  ...
                                  document.location.href='staff_register.php';
                                      ...
                                      redirect("<h4 style='color: orange;' >Password  field cannot be  empty !!!</h4>","staff_register.php");
                                     }
                                      ...
                                      redirect("<h4 style='color: orange;'>Enter your Sub Division please Field cannot be empty !!!</h4>","staff_register.php");
                                     }
                               }
                                 ...
                                 else
                                 {
                                  ...
                                  redirect("<h4 style='color: orange;'>Enter your Region please Field cannot be empty !!! </h4>","staff_register.php");
                                 }
                      }
                             else 
                            {
                              ...
                              redirect("<h4 style='color: orange;'>Enter your Field please Field cannot be empty !!!</h4>","staff_register.php");
                            }
                  } 
                       else
                       {
                        ...
                        redirect("<h4 style='color: orange;'>Enter GPS please GPS cannot be empty !!!</h4>","staff_register.php");
                      }
                } 
                    else
                     {
                      ...
                      redirect("<h4 style='color: orange;'>Enter CIC Name please CIC Name cannot be empty !!!</h4>","staff_register.php");
                    }                  
              } 
                    else
                    {
                     ...
                     redirect("<h4 style='color: orange;'>Enter Email please Email cannot be empty !!!</h4>","staff_register.php");
                   }
                    ...
                    else
                    {
                     ...
                     redirect("<h4 style='color: orange;'>Contact enetered must up to 10 digits  !!!</h4>","staff_register.php");
                     }
              ...
              document.location.href='staff_register.php';
                      ...
                      redirect("<h4 style='color: orange;' > ID NIA Existed Already   !!!</h4>","staff_register.php");
                     }
                 ...
                 redirect("<h4 style='color: orange;' > Contact Existed Already  !!!</h4>","staff_register.php");
                }
        } 
          else
            { 
            ...
            redirect("<h4 style='color: orange;' >Email Existed Already  !!!</h4>","staff_register.php");
            }
  }
           else
            {     
             ...
             redirect("<h4 style='color: orange;' > Password and Confirm Password does not match  !!!</h4>","staff_register.php");
          }
    ...
    redirect("<h4 style='color: orange;' > first Name and Last Name cannot be left Empty  !!!</h4>","staff_register.php");
  }
