     ...
     <div class="card-header" style="background-color: #3b5998 ;">
      <h5 style="color:white ;">Add Activities</h5>
       ...
       <form action="codes/staff_activity_code.php" method="POST">
        ...
        <div class="form-group row">
        <textarea  class="form-control"  name="others" rows="5" cols="10" required> Write Activities Here
        ...
        <div class="mb-3">          
          <button type="submit" name="save_activity" class="btn btn-outline-info">Save Activity</button>
        </div>
