                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            $i=1;
                            $region= $data['region'];
                            $staff_Qry="SELECT * FROM activity WHERE region='$region' ";
                            ...
                            if($result)
                            {
                                while ($row=$result->fetch_assoc())
                                {
                                    ...
                                    <tr id="<?= $row['id'] ?>">
                                        ...
                                        <td>
                                            <a href="ad_editActivity.php?id=<?= $row['id'] ?>" class="btn btn-success">Edit</a></td>
                                        <td>
                                            <form action="codes/ad_activity_code.php" method="POST">
