      ...
      <h5 style="color:white ;">Add Training</h5>
       ...
       <form action="codes/ad_training_code.php" method="POST">
        ...
        <div class="col-sm-6 mb-3 mb-sm-0">
          ...
          <input type="text" name="trainingPlace" value="<?=$data['cicName'];  ?> "  class="form-control" />
        </div>
       
        <div class="col-sm-6 mb-3 mb-sm-0">          
          <label for="">Training Region</label>
          <input type="text" name="trainingRegion"  value="<?=$data['region'];  ?> " class="form-control"  />
        </div>
        </div>
        ...
        <div class="mb-3">          
          <button type="submit" name="save_training" class="btn btn-outline-info">Save Training</button>
        </div>
