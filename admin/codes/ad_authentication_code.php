...
<?php 
include_once('controllers/ad_RegisterController.php');
include_once('controllers/ad_loginController.php');
include_once('controllers/ad_updateController.php');
include_once('controllers/ad_changePasswordController.php');
                     ...
                     {
                       {
                        ...
                        document.location.href='ad_settings.php';
                        </script>";
...
if(isset($_POST['update']))
{
  ...
  if( $result)
  {
    ...
    document.location.href='ad_profile.php';
    </script>";
    redirect(" <h5 style='color: green';> Profile Updated  Successfully </h5>","ad_profile.php");
  }else 
  { 
    echo "  <script>
    alert(' Profile Update  fails   !!! ');
    document.location.href='ad_editProfile.php';
    </script>";
...
if(isset($_POST['register']))
{
  ...
  if( $result_names){
      ...
      { 
        ...
        if(!$result_contact)
        {
           ...
           if(!$result_nia)
            {   $result_phoneNumber=$register->phoneNumberFormat($contact);
             if($result_phoneNumber)
             {
                ...
                if( $result_isCicnameEmpty)
                {
                  ...
                  if( $result_isGpsNameEmpty)
                  {
                        ...
                        if( $result_isRegionEmpty)
                          {
                            ...
                            { $result_isPasswordEmpty=$register->IsPasswordEmpty($password);
                              ...
                              if($result_isPasswordEmpty){
                                   ...
                                   if($register_query)
                                      {
                                        ...
                                        document.location.href='ad_login.php';
                                          ...
                                          redirect("<h4 style='color:green;'>Registered Successfully !!!</h4>","ad_login.php");
                                       }
                                     else
                                      {
                                        echo "  <script>
                                        ...
                                        document.location.href='ad_register.php';
                                         ...
                                         redirect("<h4 style='color: orange;'>Something Went Wrong !!!</h4>","ad_register.php");
                                      }
                                }  
                               else
                                {
                                ...
                                redirect("<h4 style='color: orange;' >Something Went Wrong with password seurity  !!!</h4>","ad_register.php");
                               }
                                  ...
                                  document.location.href='ad_register.php';
                                      ...
                                      redirect("<h4 style='color: orange;' >Password  field cannot be  empty !!!</h4>","ad_register.php");
                                     }
                                      ...
                                      redirect("<h4 style='color: orange;'>Enter your Sub Division please Field cannot be empty !!!</h4>","ad_register.php");
                                     }
                               }
                                 ...
                                 else
                                 {
                                  ...
                                  redirect("<h4 style='color: orange;'>Enter your Region please Field cannot be empty !!! </h4>","ad_register.php");
                                 }
                      }
                             else 
                            {
                              ...
                              redirect("<h4 style='color: orange;'>Enter your Field please Field cannot be empty !!!</h4>","ad_register.php");
                            }
                  } 
                       else
                       {
                        ...
                        redirect("<h4 style='color: orange;'>Enter GPS please GPS cannot be empty !!!</h4>","ad_register.php");
                      }
                } 
                    else
                     {
                      ...
                      redirect("<h4 style='color: orange;'>Enter CIC Name please CIC Name cannot be empty !!!</h4>","ad_register.php");
                    }                  
              } 
                    else
                    {
                     ...
                     redirect("<h4 style='color: orange;'>Enter Email please Email cannot be empty !!!</h4>","ad_register.php");
                   }
                    ...
                    else
                    {
                     ...
                     redirect("<h4 style='color: orange;'>Contact enetered must up to 10 digits  !!!</h4>","ad_register.php");
                     }
              ...
              document.location.href='ad_register.php';
                      ...
                      redirect("<h4 style='color: orange;' > ID NIA Existed Already   !!!</h4>","ad_register.php");
                     }
                 ...
                 redirect("<h4 style='color: orange;' > Contact Existed Already  !!!</h4>","ad_register.php");
                }
        } 
          else
            { 
            ...
            redirect("<h4 style='color: orange;' >Email Existed Already  !!!</h4>","ad_register.php");
            }
  }
           else
            {     
             ...
             redirect("<h4 style='color: orange;' > Password and Confirm Password does not match  !!!</h4>","ad_register.php");
          }
    ...
    redirect("<h4 style='color: orange;' > first Name and Last Name cannot be left Empty  !!!</h4>","ad_register.php");
  }
