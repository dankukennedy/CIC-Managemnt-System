...
if(isset($_POST['deleteInventory'])) 
{
   ...
   if($result)
   {
      redirect("Report Deleted Successfully","ad_viewInventory.php");
   }
   else
   {
      redirect("Something Went Wrong","ad_viewInventory.php");
    }
...
if($result)
{
   redirect("Report Updated Successfully","ad_viewInventory.php");
}
  else
  {
   redirect("Something Went Wrong, Report Cannot Be Updated","ad_editInventory.php");
  }
...
$result=$inventory->createInventory($inputData);
 if($result)
 {
    redirect(" <h4 style='color:green; font:200'>Inventory Added Successfully</h4>","ad_inventory.php");
 } else
 {
    redirect("Something Went Wrong, Inventory Cannot Be Added","ad_addInventory.php");
 }
