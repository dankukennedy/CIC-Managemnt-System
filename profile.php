...
<div class="container emp-profile">
            <form method="post" id="form" class="form" enctype="multipart/form-data">
                <div class="row">
                                        ...
                                        elseif($imageSize>1200000)
                                          ...
                                          document.location.href='ad_profile.php';
                                             ...
                                             else
                                             {
                                                ...
                                                $managerUpdateQuery=" UPDATE managers SET profile_img='$newImageName'  WHERE id='$id' ";
                    ...
                    <div class="col-md-2">
                        <a href="<?php base_url('editProfile.php') ;?>?id=<?=$data['id'];?>"><i class="btn btn-info">Edit Profile</i></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
