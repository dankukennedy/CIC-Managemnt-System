...
if(isset($_POST['deleteTraining'])) 
{
   ...
   if($result)
   {
      redirect("Training Deleted Successfully","viewTraining.php");
   }
   else
   {
      redirect("Something Went Wrong","viewTraining.php");
    }
...
if($result)
{
   redirect("Training Updated Successfully","viewTraining.php");
}
  else
  {
   redirect("Something Went Wrong, Training Cannot Be Updated","editTraining.php");
  }
...
$result=$training->createTraining($inputData);
 if($result)
 {
    redirect(" <h4 style='color:green; font:200'>Training Added Successfully</h4>","train.php");
 } else
 {
    redirect("Something Went Wrong, Training Cannot Be Added","addTraining.php");
 }
