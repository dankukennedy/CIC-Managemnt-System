...
if(isset($_POST['deletePayment'])) 
{
   ...
   if($result)
   {
      redirect("payment Deleted Successfully","payment.php");
   }
   else
   {
      redirect("Something Went Wrong","payment.php");
    }
...
if($result)
{
   redirect("Payment Updated Successfully","payment.php");
}
  else
  {
   redirect("Something Went Wrong, Payment Cannot Be Updated","editPayment.php");
  }
...
$result=$payment->createPayment($inputData);
 if($result)
 {
    redirect(" <h4 style='color:green; font:200'>Your Payment Details Added Successfully</h4>","payment.php");
 } else
 {
    redirect("Something Went Wrong, Your Payment Details Not Added Successfully","addPayment.php");
 }
