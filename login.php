                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Manager Welcome Back!</h1>
                                        <h1 class="h4 text-gray-900 mb-4"><?php include('include/message.php'); ?></h1>
                                    </div>
                                   ...
                                   <!-- <div class="text-center">
                                    ...
                                    <div class="text-center">
                                        <a class="medium" href="<?= base_url('register.php') ;?>" style="text-decoration:none;">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
